...
import com.demo.tiktok_likes_new.net.parser.WasmScortApiGetHistoryParser;
import com.demo.tiktok_likes_new.net.request.WasmScortApiGetHistoryRequest;
import com.demo.tiktok_likes_new.net.request.WasmScortApiGetHistoryResponse;
import com.demo.tiktok_likes_new.net.request.WasmScortApiRemoveHistoryRequest;
...
public class WasmScortThreeFragment extends WasmScortBaseFragment {
    ...
    class ListDataAdapter extends RecyclerView.Adapter<ListDataAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.state.setText(item.getScsf() + " " + getStrObj(R.string.wasm_scort_awq) + " " + item.getLsbl());
        }
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View itemView) {
                ...
                closeIcon.setOnClickListener(v -> {
                    new AlertDialog
                            .Builder(getActivity())
                            .setMessage(getStrObj(R.string.wasm_scort_cfbbnn))
