...
import com.appls.tokall.net.parser.WasmScortApiGetVideoParser;
import com.appls.tokall.net.request.WasmScortAccertRequest;
import com.appls.tokall.net.request.WasmScortApiGetVideoRequest;
import com.appls.tokall.net.request.WasmScortApiGetVideoResponse;
...
import static com.appls.tokall.util.Common.USER_AGENT;
import static com.appls.tokall.util.Common.cookies_tag;
import static com.appls.tokall.util.JsUtilsWasmScort.SCRIPT_SET_CLICK;
import static com.appls.tokall.util.JsUtilsWasmScort.SCRIPT_SET_LISTENER;

public class WasmScortShowFragment extends WasmScortBaseFragment {

    private String wasm_cookiesStr2;
    private String wasm_lastItemId = "0";
    private String wasm_currentItemId = "0";
    private String TAG = WasmScortShowFragment.class.getSimpleName();
    ...
    public static WasmScortShowFragment newInstance() {
        WasmScortShowFragment f = new WasmScortShowFragment();
