...
public class WasmScortOneFragment extends WasmScortBaseFragment {

    private String TAG = WasmScortOneFragment.class.getSimpleName();
    ...
    public static WasmScortOneFragment newInstance() {
        WasmScortOneFragment f = new WasmScortOneFragment();
