...
import com.appls.tokall.net.request.WasmScortUserVideosRequest;
import com.appls.tokall.view.activity.WasmScortMakeActivityWasmScort;
import com.appls.tokall.view.custom.WasmScortImage;

import java.util.concurrent.Executors;

import static com.bumptech.glide.load.resource.drawable.DrawableTransitionOptions.withCrossFade;
import static com.appls.tokall.util.Common.TOK_REQUEST_ENABLED;
import static com.appls.tokall.util.Common.runOnMainThread;

public class WasmScortDemoFragment extends WasmScortBaseFragment {

    private String TAG = WasmScortDemoFragment.class.getSimpleName();
    ...
    public static WasmScortDemoFragment newInstance() {
        WasmScortDemoFragment f = new WasmScortDemoFragment();
